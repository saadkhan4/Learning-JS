...
console.log("I'm "+firstName +lastName+" and I'm "+age+" years old.") // old way of concatenation.
console.log(`I'm ${firstName} ${lastName} and I'm ${age} years old`); // modern way of concatenation using template literals.
